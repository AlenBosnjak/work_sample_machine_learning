...
def request_lineups(season, league_id, store_json_path, con):
    cur = con.cursor()
    ...
    for i in range(0, len(fixture_id)):
            ...
            if(i%400 == 0 and i !=0):
                ...
                print("lineup: Wait for reqeust per minute")
                print("i =", i)
                time.sleep(x)

            
            str_request = "/fixtures/lineups?fixture=" + str(fixture_id[i][0])
